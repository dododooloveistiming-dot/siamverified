...
const config: Config = {
  ...
  // PlacePlaceholder generates niche-specific gradient classes from a JS
  // lookup. Tailwind's JIT can't trace it, so safelist the full set.
  safelist: [
    "bg-gradient-to-br",
    "from-rose-500", "from-violet-400", "from-emerald-400", "from-amber-400",
    "from-sky-500", "from-pink-400", "from-slate-500",
    "via-orange-500", "via-pink-400", "via-teal-400", "via-orange-400",
    "via-cyan-500", "via-rose-400", "via-zinc-500",
    "to-amber-500", "to-fuchsia-500", "to-cyan-500", "to-red-400",
    "to-blue-600", "to-purple-500", "to-stone-600",
  ],
  theme: {
    extend: {
      colors: {
